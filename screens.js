module.exports = [{
  ...
  project: {
    title: 'Hive',
    description: '<p>Human-friendly bitcoin wallet<br>designed for iOS & Android.</p>',
    emoji: '<span data-icon="bee"></span>',
    outro: 'hivewallet.com',
    link: 'http://hivewallet.com',
    images: ['hive.jpg']
  }
}, {
  project: {
    ...
    outro: 'watch demo',
    link: 'https://vimeo.com/113909710',
    images: ['uome.jpg']
  }
}, {
  project: {
  ...
  html: '<h2>Currently working with <a href="http://coinbase.com"><span class="underline">Coinbase</span>.</a></h2>',
  project: false
}];